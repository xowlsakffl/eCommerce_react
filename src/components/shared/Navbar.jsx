    ...
    return (
        <div className="h-[70px] bg-custom-gradient text-white z-50 flex items-center sticky top-0">
            <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
                ...
                <ul className={`flex sm:gap-10 gap-6 sm:items-center  text-slate-800 sm:static absolute left-0 top-[70px] sm:shadow-none shadow-md ${
                    ...
                    <li className="font-[500] transition-all duration-150 py-2">
                        <Link className={`${
                    ...
                    {(user && user.id) ? (
                        ...
                        <li className="font-[500] transition-all duration-150">
                            <Link className="flex items-center space-x-2 px-4 py-[6px] 
                                ...
                                duration-300 ease-in-out transform" to="/login">
                                <FaSignInAlt />
                                <span>로그인</span>
                            </Link>
                        </li>
