...
const Checkout = () => {
    ...
    const handleNext = () => {
        ...
        if(activeStep === 1 && (!selectedUserCheckoutAddress || !paymentMethod)) {
            toast.error("배송지와 결제 수단을 모두 선택해주세요.");
            return;
        }
  ...
  return (
    <div className='py-14 min-h-[calc(100vh-100px)] font-notosans'>
            ...
            <div className='mt-5'>
                ...
                {activeStep === 3 && (
                    <>
                        ...
                        {paymentMethod === "Kakao" && <KakaoPayment />}
                        {paymentMethod === "Naver" && <NaverPayment />}
                    </>
                )}
            </div>
        )}
